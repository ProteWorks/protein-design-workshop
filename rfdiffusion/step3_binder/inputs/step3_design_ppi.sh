...
# We make 2 designs, and reduce the noise added during inference to 0, to improve the quality of the designs

python /app/RFdiffusion/scripts/run_inference.py\
	inference.output_prefix=/workdir/output/design_ppi\
	inference.input_pdb=/workdir/insulin_target.pdb\
	'contigmap.contigs=[A1-150/0 70-100]'\
	'ppi.hotspot_res=[A59,A83,A91]'\
	inference.num_designs=2\
	denoiser.noise_scale_ca=0\
	denoiser.nose_scale_frame=0 
